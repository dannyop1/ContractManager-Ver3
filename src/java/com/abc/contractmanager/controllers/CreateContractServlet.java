...
public class CreateContractServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int rentalFee = Integer.parseInt(request.getParameter("intRentalFee"));
            ...
            if (!brk) {
                ContractDAO.createContract(RoID, userID, OID, rentalFee, 0, from, to, contractName, description);
            }
