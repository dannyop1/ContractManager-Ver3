...
public class ContractDTO {
    ...
    public ContractDTO(int CoID, int RoID, int UID, String UName, int OID, String OName, int rentalFee, int systemFee, Date createDate, Date endDate, String name, String description, int status) {
        this.CoID = CoID;
        this.RoID = RoID;
        this.UID = UID;
        this.UName = UName;
